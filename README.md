...
do sistema operacional para a versão mais recente(Windows 7 PRO para Windows 11 PRO). Para tornar mais branda a migração que já teria como
desafio a mudança da interface gráfica, optou-se por utilizar o mesmo arquivo de banco de dados, não sendo feita a atualização do banco.
